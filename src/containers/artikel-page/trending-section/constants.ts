...
import { ArticleFilter } from '@/types/newsTypes';
...
export const trendingArticles: Article[] = [
  {
    ...
    content: 'Home terrace decorations are part of every decoration or overall home design. Interiordesign.id – If by chance your house has enough space or space.',
    date: new Date(),
    imgUrl: '/article8.png',
    author: {
      id: 2,
  ...
  },
  {
    ...
    content: "Is it true that the bedroom design is the most personal reflection of the owner? Many people believe that to be able to judge a person's personality, it is enough to",
    date: new Date(),
