export const SkectchStar = ({ className }: { className: string }) => {
  return (
...
export const SketchArrow = ({ className }: { className: string }) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' className={className} width='327' height='327' viewBox='0 0 327 327' fill='none'>
      <path
